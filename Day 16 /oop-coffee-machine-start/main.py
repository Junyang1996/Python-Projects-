...
while not off:
    ...
    if order == "off":
        ...
        #     Coffee: 76g
        #     Money: $2.5
        m_coffeemaker.report()
    else:
        beverage_of_choice = m_menu.find_drink(order)
        ...
        if m_coffeemaker.is_resource_sufficient(beverage_of_choice):
            ...
            if not m_payment.make_payment(beverage_of_choice.cost):
                ...
                m_coffeemaker.make_coffee(beverage_of_choice)
